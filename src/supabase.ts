...
// TEMPORARY: Hardcoded until env setup is restored
const supabaseUrl = 'https://iybchsakopqvccjythby.supabase.co';
const supabaseAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml5YmNoc2Frb3BxdmNjanl0aGJ5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDk1MjA4MjIsImV4cCI6MjA2NTA5NjgyMn0.JbXPBEJqAbMIli4NntGn-36eWck2fqdxGUbl3dxFtok';
