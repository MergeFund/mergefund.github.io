      ...
      <nav className="relative z-50 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#8A2BE2] to-[#FF69B4] flex items-center justify-center overflow-hidden">
              <Image
                src="/assets/roundedLogoNoWords.png"
                alt="MergeFund Logo"
                width={40}
                height={40}
      ...
      <section className="relative px-6 py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
            MergeFund incentivizes developers with cryptocurrency rewards for
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center group">
              ...
              <p className="text-gray-300 leading-relaxed">
                Repository owners post bounties on GitHub issues with crypto
                rewards to incentivize quality contributions.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-300 leading-relaxed">
                Developers solve issues and submit pull requests. Our platform
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Get paid in crypto for your open-source contributions.
                      Build wealth while building software.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Smart contracts ensure automatic and transparent reward
                      distribution. No delays, no disputes.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Showcase your skills and build a verifiable track record
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Access bounties from projects worldwide. Work on what
                      interests you most.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Incentivize skilled developers to contribute to your
                      projects with crypto rewards.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Get critical bugs fixed and features implemented faster
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Track exactly how your development budget is being spent
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Our reputation system ensures only quality contributors
                      work on your issues.
                    </p>
                  </div>
                </div>
      ...
      <section id="waitlist-section" className="px-6 py-20 bg-[#16213E]/50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-12">
            Be among the first to experience the future of open-source
            development. Join our waitlist and get early access to MergeFund.
          </p>
